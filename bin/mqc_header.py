...
multiqc_list += ["intro_text: >\n This report has been generated by the scChIP-inDrop analysis pipeline (v{}) based on Prompsy et al. Nat Comm 2020 and Grosselin et al. Nat Genet 2019".format(args.version) ]
...
multiqc_list += ["custom_plot_config:"]
multiqc_list += ["   umiDistrib:"]
multiqc_list += ["      xPlotLines:"]
multiqc_list += ["         - color: '#a9a9a9'"]
multiqc_list += ["           value: " + str(2)]
multiqc_list += ["           dashStyle: 'LongDash'"]
multiqc_list += ["           width: 1"]
multiqc_list += ["           label:"]
multiqc_list += ["              style: {color: '#a9a9a9'}"]
